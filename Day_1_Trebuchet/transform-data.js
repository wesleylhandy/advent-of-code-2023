...
function stripNonNumerics(datum) {
    ...
    return strippedDatum.length === 0
        ? '0'
        : strippedDatum[0] + strippedDatum[strippedDatum.length - 1]
}

module.exports.decodeDataIntoCalibrationValues = decodeDataIntoCalibrationValues;
module.exports.decodeDataIntoCalibrationValuesReadingEnglishNumbers = decodeDataIntoCalibrationValuesReadingEnglishNumbers;